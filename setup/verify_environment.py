...
It checks that everything Lab 1 needs is installed, and tells you exactly
...
check(
    os.path.exists(os.path.join(lab_folder, "lab1_unit_converter.ipynb")),
    "Lab 1 notebook found",
...
print("-" * 60)
if all(results):
    print("  All set. Open lab1_unit_converter.ipynb and start Lab 1.")
else:
