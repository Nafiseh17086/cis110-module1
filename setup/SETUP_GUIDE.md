...
2. Download the Module 1 zip from Canvas and **extract it** into that folder:
   - Windows: right-click the zip → **Extract All**.
   - macOS: double-click the zip.
3. In VS Code, choose **File → Open Folder** and open the extracted
   `cis110-module1` folder.
...
Click `lab1_unit_converter.ipynb`. When VS Code asks you to **Select Kernel**,
